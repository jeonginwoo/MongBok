    ...
    landscape: {
      ...
      layouts: {
        1: {
          layout1: {
            view: {
              1: { id: 1, type: "view", style: { top: `${(100 - r16_9a11 * r16_10) / 2}%`, left: `0%`, width: `${r16_9a11}%`, height: `${r16_9a11 * r16_10}%` } },
            },
            chat: {
              1: { id: 1, type: "chat", style: { top: `0%`, left: `${r16_9a11}%`, width: `${(100 - r16_9a11)}%`, height: `100%` } },
            },
