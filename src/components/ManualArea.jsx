      ...
      <Box sx={{ maxWidth: 800, mx: "auto", pb: 10 }}>
        ...
        <Section title="채널 관리">
          ...
          <Item
            ...
            secondary={[
              ...
              '채널 목록에 추가할 항목을 channels 항목에 "플랫폼명:채널ID": {} 형식으로 입력 후 저장하면 됩니다.',
              '이전의 "채널ID": { "platform": "플랫폼명" } 키 형식도 인식되어 저장 시 자동 변환됩니다.',
        ...
        <Section title="컨트롤러">
          ...
          <Item
            ...
            secondary={[
              "컨트롤러(+설정)를 별도 창으로 분리해 리모컨처럼 사용할 수 있습니다.",
              "전체 화면은 브라우저 정책상 메인 창에서 F 키로 사용해야 합니다.",
            ]}
          />
          <Item
            icon={<FullscreenIcon />}
        ...
        <Section title="참고사항">
          ...
          <Item
            ...
            primary="치지직 (CHZZK)"
            secondary={[
              "라이브를 페이지 임베드 없이 전용 플레이어로 직접 재생해 가볍고, 실시간과의 지연이 약 3초로 짧습니다.",
              "화질은 기본 1080p로 시작하며, 플레이어 우측 하단의 화질 버튼에서 변경할 수 있습니다.",
              "일시정지 후 다시 재생하면 밀린 시간을 건너뛰고 자동으로 실시간 시점으로 이동합니다. 하단의 LIVE 뱃지를 눌러도 실시간으로 이동합니다.",
              "소리는 기본 켜짐이지만, 브라우저 자동재생 정책에 따라 음소거로 시작될 수 있습니다. 이때는 화면 클릭이나 키 입력 시 소리가 켜지며, 브라우저 사이트 설정에서 '소리'를 허용하면 항상 소리와 함께 시작됩니다.",
              "방송이 오프라인이면 채널 프로필과 함께 오프라인 화면이 표시됩니다.",
              "전용 플레이어 재생에 실패하면 치지직 페이지 전체를 불러오는 방식으로 자동 전환됩니다.",
            ]}
          />
          <Item
            icon={
