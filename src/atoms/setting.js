...
// layoutType
export const layoutTypeAtom = atomWithStorage("layout", "layout1");

// ratio
export const ratioAtom = atomWithStorage("ratio", "16:9-landscape");
...
// 현재 시간 on/off
export const showCurrentTimeAtom = atomWithStorage("showCurrentTime", true);
...
// 테마 on/off
export const themeModeAtom = atomWithStorage("themeMode", "dark");
