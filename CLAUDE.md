...
- eslint has two rules temporarily downgraded to warn (`no-unused-vars`,
  `react-hooks/rules-of-hooks`) while existing debt is paid off — see the
  PROGRESS work queue. Never add NEW warnings of these kinds.
